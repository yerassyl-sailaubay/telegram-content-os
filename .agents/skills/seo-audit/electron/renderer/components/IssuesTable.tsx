      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="bg-[var(--color-bg-hover)]">
            <th
              className="p-3 text-left text-xs font-medium tracking-wide uppercase"
            ...
            <th
              className="p-3 text-center text-xs font-medium tracking-wide uppercase"
              style={{ color: "var(--color-text-muted)" }}
            >
              Severity
            </th>
              ...
              <td className="p-3 text-center">
                <span
                  ...
                  style={{
                    ...
                    backgroundColor:
                      issue.status === "fail" ? "var(--color-fail-bg)" : "var(--color-warn-bg)",
                  }}
                >
