...
describe("Content Rules", () => {
  ...
  describe("keywordStuffingRule", () => {
    ...
    it("should ignore stopwords in calculation", async () => {
      ...
      const stopwords =
        "the and is are was were be been being have has had do does did will would could should may might must can shall ";
  ...
  describe("articleLinksRule", () => {
    it("should pass for appropriate link density", async () => {
      const links =
        '<a href="/page1">Link 1</a> <a href="/page2">Link 2</a> <a href="https://external.com">External</a>';
  ...
  describe("brokenHtmlRule", () => {
    it("should pass for valid HTML structure", async () => {
      const html =
        "<html><head><title>Test</title></head><body><h1>Title</h1><p>Content</p></body></html>";
      const context = createContext(html);
  ...
  describe("metaInBodyRule", () => {
    it("should pass when all meta in head", async () => {
      const html =
        '<html><head><meta name="description" content="Test"><title>Test</title></head><body></body></html>';
      const context = createContext(html);
    ...
    it("should fail when meta tag in body", async () => {
      const html =
        '<html><head></head><body><meta name="description" content="Wrong place"></body></html>';
      const context = createContext(html);
      const result = await metaInBodyRule.run(context);
      expect(result.status).toBe("fail");
    });
    ...
    it("should fail when canonical in body", async () => {
      const html =
        '<html><head></head><body><link rel="canonical" href="https://example.com"></body></html>';
      const context = createContext(html);
      const result = await metaInBodyRule.run(context);
      expect(result.status).toBe("fail");
    });
  ...
  describe("duplicateDescriptionRule", () => {
    ...
    it("should pass for unique description", async () => {
      const html =
        '<html><head><meta name="description" content="This is a unique page description that is long enough to be valid."></head><body></body></html>';
    ...
    it("should warn for duplicate descriptions", async () => {
      const desc =
        "This is a duplicate description that appears on multiple pages for testing purposes.";
    ...
    it("should detect duplicates with different case", async () => {
      const html1 =
        '<html><head><meta name="description" content="Same Description Here for testing."></head></html>';
      const html2 =
        '<html><head><meta name="description" content="SAME DESCRIPTION HERE FOR TESTING."></head></html>';
    ...
    it("should track registry stats correctly", async () => {
      const html1 =
        '<html><head><meta name="description" content="Description A is unique and long enough."></head></html>';
      const html2 =
        '<html><head><meta name="description" content="Description B is also unique and long enough."></head></html>';
      const html3 =
        '<html><head><meta name="description" content="Description A is unique and long enough."></head></html>';
    ...
    it("should reset registry between audits", async () => {
      const html =
        '<html><head><meta name="description" content="Test description that is long enough for validation."></head></html>';

      await duplicateDescriptionRule.run(createContext(html, {}, "https://example.com/1"));
      resetDescriptionRegistry();

      const result = await duplicateDescriptionRule.run(
        createContext(html, {}, "https://example.com/2"),
      );
