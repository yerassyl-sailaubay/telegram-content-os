...
export const affiliateDisclosureRule = defineRule({
  ...
  run(context: AuditContext): RuleResult {
    ...
    const hasDisclosurePage =
      $('a[href*="disclosure"], a[href*="affiliate"], a[href*="sponsored"]').filter((_, el) => {
    ...
    return {
      ...
      details: {
        ...
        affiliateLinks: affiliateLinks.slice(0, 5),
        recommendation:
          'Add a clear affiliate disclosure near the top of content. Example: "This post contains affiliate links. We may earn a commission at no extra cost to you."',
      },
    };
  },
});
