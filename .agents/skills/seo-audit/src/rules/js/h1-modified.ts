...
export const h1ModifiedRule = defineRule({
  ...
  run: async (context: AuditContext) => {
    ...
    if (!comparison) {
      return pass("js-h1-modified", "Unable to compare H1 elements");
    }
    ...
    if (comparison.differs) {
      return warn("js-h1-modified", "H1 heading was modified by JavaScript execution", {
        ...
        recommendation:
          "Set the correct H1 heading in server-side HTML rather than modifying it with JavaScript",
      });
    }

    return pass("js-h1-modified", "H1 heading is unchanged after JavaScript execution", {
