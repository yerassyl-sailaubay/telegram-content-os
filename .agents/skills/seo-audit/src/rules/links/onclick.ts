...
export const onclickRule = defineRule({
  ...
  description:
    "Checks for elements using onclick handlers for navigation instead of proper href attributes",
  category: "links",
  weight: 5,
  run: (context: AuditContext) => {
    ...
    return pass("links-onclick", "No onclick-based navigation detected");
  },
});
