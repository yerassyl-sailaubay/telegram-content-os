...
export function ChannelProfileCard({ profile, onRefresh }: ChannelProfileCardProps) {
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        {profile.niche && (
          <div>
            <p className="text-muted-foreground text-sm font-medium">{t("niche")}</p>
        ...
        {profile.tone && (
          <div>
            <p className="text-muted-foreground text-sm font-medium">{t("tone")}</p>
        ...
        {profile.topTopics.length > 0 && (
          <div>
            <p className="text-muted-foreground mb-1.5 text-sm font-medium">{t("topTopics")}</p>
        ...
        {/* Language */}
        <div>
          <p className="text-muted-foreground text-sm font-medium">{t("language")}</p>
